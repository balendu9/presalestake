...
const Contact = ({setContactUs }) => {
  ...
  // }
  return (
    <div className="modal modal--auto fade show" id="modal-ask" tabIndex={-1} aria-labelledby="modal-ask" aria-hidden="true" role="dialog" style={{display: "block", paddingLeft: 0,}}>
     <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal__content">
            ...
            <h4 className="modal__title">Ask Question</h4>
            <p className="modal__text">mail at support@techs.network</p>
            ...
            {/* <form onSubmit={handleSubmit} className="modal__form" >
              ...
              <div className="form__group">
                <textarea type="message" name="message" id="message" className="form__textarea" placeholder="Ask Question"/>
                <ValidationError prefix="Message" field="message" error={state.errors} />
              </div>
              <button type="submit" className="form__btn" disabled={state.submitting}>Send</button>
            </form> */}
    </div>
