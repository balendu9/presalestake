              ...
              <div key={index} className={`col-12 ${index === 0 || index === 1 ? "col-md-6" : index === 2 ? "" : ""} col-lg-4`}>
                <div className="apool">
                  <h3 className="apool__title">
                    {index == 0 ? "Maximum": index == 1 ? "Standard" : index == 2 ? "Lite" : "Advanced"}
                  </h3>
                  <ul className={`nav nav-tabs apool__tabs apool__tabs--${index == 0 ? "orange" : index == 1 ? "green" : index == 2 ? "blue" : "orange" }`} id={index == 0 ? "apool__tabs1" : index == 1 ? "apool__tabs2" : index == 2 ? "apool__tab3" : "" } role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="active" data-bs-toggle="tab" data-bs-target={
